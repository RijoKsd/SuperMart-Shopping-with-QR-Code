...
//
//public class customViewOfferFromCart extends AppCompatActivity {
//
//    @Override
//    protected void onCreate(Bundle savedInstanceState) {
//        super.onCreate(savedInstanceState);
//        setContentView(R.layout.activity_custom_view_offer_from_cart);
//    }
//}
...
public class customViewOfferFromCart extends BaseAdapter {
    String[] offerPercentage,offerPrice,offerStartDate,offerEndDate,productID,sId;
    private Context context;


    public customViewOfferFromCart(Context applicationContext, String[] offerPercentage, String[] offerPrice, String[] offerStartDate, String[] offerEndDate, String[] productID,String[] sId) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view==null)
        {
            ...
            gridView=inflator.inflate(R.layout. activity_custom_view_offer_from_cart,null);//same class name
